...
- Sous `prefers-reduced-motion`, chaque moment devient un court fondu ; rien ne clignote plus de trois fois par seconde. Les variables CSS `--motion-*` sont déjà réduites dans `web/design/src/composants.css`.
